...
const studentWorks = [
  ...Array.from({ length: 12 }, (_, index) => ({ src: `/student-works/brand-${String(index + 1).padStart(2, "0")}${[0, 4, 5, 6].includes(index) ? ".jpg" : ".png"}`, category: "LOGO & BRANDING", title: [6, 7].includes(index) ? "브랜드 아이덴티티 응용 목업" : "나만의 로고·브랜드 디자인" })),
